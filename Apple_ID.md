![GitHub Logo](pic/Apple1.PNG)
  ...
  * Two-Factor Authentication หรือ ระบบการยืนยันตัวตนแบบสองชั้น ซึ่งจะมีประโยชน์ที่เห็นได้ชัด ในกรณีที่ชื่อผู้ใช้และรหัสผ่านของเรา ตกไปอยู่ในมือของคนอื่น และมีเจตนาจะนำข้อมูลเหล่านั้นของเราไปกรอกเข้าระบบ จะไม่สามารถเข้าใช้งานได้ เพราะรหัสอีกชุดหนึ่งจะถูกส่งเข้าโทรศัพท์ หรืออีเมล์ส่วนตัว โดยระบบ Two-Factor Authentication จะมีสิ่งที่สำคัญ 3 อย่างด้วยกันดังนี้
